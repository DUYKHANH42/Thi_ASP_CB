...
<asp:Content ID="Content1" ContentPlaceHolderID="NoiDung" runat="server">
    ...
    <div class="form-inline justify-content-center">
                Chọn địa điểm
                <asp:DropDownList OnSelectedIndexChanged="ddlDiadiem_SelectedIndexChanged"  ID="ddlDiadiem" runat="server"
     ...
     <asp:Repeater ID="RptTour" runat="server">
         <ItemTemplate>
             <div class="col-md-4 text-center">
                 <img src='/Hinh_tour/<%# Eval("Hinh")%>' style="width: 250px" />
                 <br />
                 <asp:Label ID="lbTen" runat="server" Text='<%# Eval("TenTour") %>'></asp:Label>
                 <br />
                 Giá tour 
 <asp:Label ID="lbGia" runat="server" ForeColor="#ff6600" Text='<%# Eval("DonGia", "{0:N0} đồng") %>'></asp:Label>
                 <br />
                 Số ngày 
                 <asp:Label ID="lbSoNgay" runat="server" ForeColor="#ff6600" Text='<%# Eval("SoNgay") %>'></asp:Label>
                 Số đêm  
                 <asp:Label ID="lbSoDem" runat="server" ForeColor="#ff6600" Text='<%# int.Parse(Eval("SoNgay").ToString()) -1 %>'></asp:Label>
                 <br />
